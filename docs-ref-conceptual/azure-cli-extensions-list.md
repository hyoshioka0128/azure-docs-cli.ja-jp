...
| [keyvault-preview](https://github.com/Azure/azure-keyvault-cli-extension) | 0.1.2 | Azure Key Vault のコマンドをプレビューします。 | [はい] |
...
| [webapp](https://github.com/Azure/azure-cli-extensions) | 0.2.2 | appservice のリソースを管理する Azure CLI 拡張機能 | [はい] |
