...
| [aks-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.47 | 次期 AKS 機能のプレビューを提供します | はい |
...
| [timeseriesinsights](https://github.com/Azure/azure-cli-extensions/src/timeseriesinsights)。 | 0.1.2 | Microsoft Azure コマンド ライン ツールの TimeSeriesInsightsClient 拡張機能 |  |
