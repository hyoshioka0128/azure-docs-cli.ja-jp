...
| [aks-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/aks-preview) | 0.4.27 | 次期 AKS 機能のプレビューを提供します | はい |
...
| [azure-firewall](https://github.com/Azure/azure-cli-extensions/tree/master/src/azure-firewall) | 0.1.9 | Azure Firewall のリソースを管理します。 | はい |
