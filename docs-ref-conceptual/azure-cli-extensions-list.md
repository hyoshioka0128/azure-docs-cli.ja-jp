...
| [azure-devops](https://github.com/Microsoft/vsts-cli/tree/azuredevopscli-dev) | 0.1.0 | Azure DevOps を管理するためのツールです。 | [はい] |
...
| [storage-preview](https://github.com/Azure/azure-cli-extensions/tree/master/src/storage-preview) | 0.2.0 | 次期ストレージ機能のプレビューを提供します。 | [はい] |
